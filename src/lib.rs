...
//! Off by default:
//!
//! - `no-fallback-drop`: panics instead of silently dropping the prompt fallback value if it
//!   gets rejected by a filter (see [`Prompt::with_fallback`] and [`Prompt::with_filter`] for
//!   more details).
//!
