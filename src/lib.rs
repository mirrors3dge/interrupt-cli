...
//! ## Crate features
//!
//! - `colored_print` (default): enables [`println_red!`], [`println_bold!`], etc. macros. When enabled, some
//!   errors printed by this crate's prompts at runtime will be colored (only works in ANSI terminals).
//!
